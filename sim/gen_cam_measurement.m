...
M = 10; % num observation per frame
obs_all = zeros(N, M, 7);  % obs = (x, y, z, u, v, n_u, n_v)
...
for k = 1 : N
    ...
    for m = 1 : M
        ...
        n_u = 2 * (rand() - 0.5) * sqrt(var_n_u);
        n_v = 2 * (rand() - 0.5) * sqrt(var_n_v);
